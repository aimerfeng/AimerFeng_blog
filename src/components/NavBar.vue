  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <a href="https://github.com/aimerfeng" target="_blank" title="GitHub" class="lt-md:hidden">
          <div i-uil-github-alt />
        </a>
        <a href="https://www.zhihu.com/people/aimerfeng-18" target="_blank" title="知乎" class="lt-md:hidden">
          <div i-simple-icons-zhihu />
        </a>
