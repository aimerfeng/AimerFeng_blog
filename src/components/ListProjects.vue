...
<template>
  <div class="max-w-300 mx-auto">
    <p text-center mt--6 mb5 op50 text-lg italic>
      Web3 and AI projects that I created or contribute to.
    </p>
    <div class="prose pb5 mx-auto mt10 text-center">
      <div flex="~ gap-2 justify-center">
        ...
        <a
          href="https://twitter.com/aimerfeng"
          target="_blank"
          class="group btn-cyan inline-block"
        >
          <div
            i-ph-twitter-logo-duotone
            group-hover="i-ph-twitter-logo-fill text-cyan"
          />
          Twitter
        </a>
        <a
          href="https://discord.gg/aimerfeng"
          target="_blank"
          class="group btn-purple inline-block"
        >
          <div
            i-ph-discord-logo-duotone
            group-hover="i-ph-discord-logo-fill text-purple"
          />
          Discord
        </a>
      </div>
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div block mt-5>
        <p op50>More projects coming soon...</p>
      </div>
      <hr>
      <SponsorButtons />
    </div>
