...
const base = 'https://aimerfeng.me'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @aimer71976\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://elk.zone/intent/post?text=${encodeURIComponent(`Reading AimerFeng\'s ${base}${route.path}\n\nI think...`)}`)
const blueskyUrl = computed(() => `https://bsky.app/intent/compose?text=${encodeURIComponent(`Reading @aimerfeng.me ${base}${route.path}\n\nI think...`)}`)
